...
const Footer = () => {
  return (
    <>
      <div className="sm:flex justify-between py-10 px-8 grid">
        ...
        <div className="text-white sm:w-[900px] sm:ml-[18%] sm:mr-[12%] pt-10 sm:pt-0">
          ...
          <div className="my-4 ">
            <div className="justify-center flex ">
              ...
              />
              <button className="bg-[#00df9a] mx-auto w-28 hover:bg-[#00f2a5] rounded-md font-medium">
                Sign Up
              </button>
            </div>
        ...
        <div className="lg:col-span-3 flex justify-between ">
          <div>
            ...
            <ul>
              ...
              <li className="py-2 text-sm cursor-pointer font-semibold">Commerce</li>
